...
<template>
  <div :class="{ nav:!isFixed, 'navbar-fixed': isFixed }">
    <div class="nav-left">
      <a href="tel:+373 (79) 33 99 33" class="contact">
    ...
    <div class="main-nav">
      <div class="products">
        <a href="https://shop.msoft.md/index.php?dispatch=categories.view&category_id=167" class="nav-btn"
           v-if="language">Catalog</a>
        <a href="https://shop.msoft.md/index.php?dispatch=categories.view&category_id=167" class="nav-btn"
           v-if="!language">Каталог</a>
      </div>
      <div class="shorthand">
    ...
    <div class="menu-wrapper">
      ...
      <div class="menu-info">
        ...
        <div class="menu-info-one">
          ...
          <div class="menu-info-suggestion">
            ...
            <a href="https://shop.msoft.md/index.php?dispatch=categories.view&category_id=167" class="one-suggestion"
               v-if="language">Catalog</a>
            <a href="https://shop.msoft.md/index.php?dispatch=categories.view&category_id=167" class="one-suggestion"
               v-if="!language">Каталог</a>
          </div>
        ...
        <div class="menu-info-one">
          ...
          <div class="menu-info-suggestion-tel">
                    <span class="one-suggestion">
                      ...
                      <a href="tel:+373 (79) 33 99 33" class="one-sugestion-word">+373 (79) 33 99 33</a>
                    </span>
            <span class="one-suggestion">
                      <div class="one-suggestion-svg">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                      ...
                      <a href="mailto:sales.b2b@takeit.md" class="one-sugestion-word">sales.b2b@takeit.md</a>
                    </span>
          </div>
        </div>
      </div>
      <div class="menu-info-logos">
        ...
        <div class="logos-images">
          <a href="https://www.facebook.com/takeit.md/" class="logos-change">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
              <path
          ...
          <a href="https://www.instagram.com/take_it_srl/" class="logos-change">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
              <path
          ...
          <a href="https://www.linkedin.com/company/take-it-srl/" class="logos-change">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
              <path opacity="0.5"
