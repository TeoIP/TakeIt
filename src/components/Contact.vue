    ...
    <div class="send-message">
      ...
      <form class="form-wrapper" method="Post" @submit.prevent="submitMessage()">
        <div class="user-info">
          ...
          <input v-if="language" required v-model="email" class="send-message-input" placeholder="exemplu@email.com"
                 type="email">
          <input v-if="!language" required v-model="email" class="send-message-input" placeholder="пример@email.com"
                 type="email">
        </div>
        <textarea v-if="language" required v-model="message" class="send-message-text" placeholder="Mesaj"
                  id="Message"></textarea>
        <textarea v-if="!language" required v-model="message" class="send-message-text" placeholder="Сообщение"
                  id="Message"></textarea>
