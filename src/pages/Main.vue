                ...
                <div class="one-circle">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" version="1.1">
                    ...
                    <circle v-motion :initial="{ 'stroke-dashoffset': 471 }"
                      :visibleOnce="{ 'stroke-dashoffset': 120, transition: { duration: 2000, delay: 200, } }" cx="80"
...
<div id="carouselExampleControls" class="carousel slide" data-interval="false">
  <div class="carousel-inner">
    <div class="carousel-item active">
      ...
      <div class="service-one-slide-title" v-if="!language">Мы разрабатываем сложные решения и приложения</div>
    ...
    <div class="carousel-item">
      ...
      <div class="service-one-slide-content" v-if="language">Sistemele de securitate sunt colecții de dispozitive menite să asigure securitatea într-o instituție. Acestea facilitează gestionarea accesului pe teritoriu, verificarea vizitatorilor și monitorizarea activităților angajaților. Sistemele pot controla dispozitivele de blocare, gestiona înregistrarea orelor de lucru, preveni situații de urgență și proteja proprietatea împotriva potențialelor infracțiuni. </div>
                <div class="service-one-slide-content" v-if="!language">Системы безопасности - это коллекции устройств, предназначенных для обеспечения безопасности в учреждении.Они облегчают управление доступом к территории, проверяют посетителей и следят за деятельностью сотрудников.Системы могут управлять блокирующими устройствами, управлять регистрацией рабочего времени, предотвращать чрезвычайные ситуации и защищать имущество от потенциальных преступлений.</div>
    </div>
    <div class="carousel-item">
      ...
      <div class="service-one-slide-content" v-if="language">Protejați eficient resursele folosind soluții inovatoare, inclusiv sistemele anti-furt EAS și senzori adaptabili pentru diverse produse și configurații de magazine. Oferim produse integrate și universale, precum sisteme antifurt AM, RF și RFID de la lideri globali precum Sensormatic și Shopguard. Asigurăm o gamă completă de instrumente pentru securitatea magazinelor, contribuind la protejarea eficientă a produselor și a mediului de retail.</div>
                <div class="service-one-slide-content" v-if="!language">Эффективно защищает ресурсы с использованием инновационных решений, в том числе систем антитипов EAS и адаптируемые датчики для различных продуктов и конфигураций магазинов.Мы предлагаем интегрированные и универсальные продукты, такие как системы AM, RF и RFID от Global Leaders и ShopGuard.Мы предоставляем полный спектр инструментов для безопасности магазина, способствуя эффективной защите продуктов и розничной среды.</div>
    </div>
    <div class="carousel-item">
      ...
      <div class="service-one-slide-content" v-if="language">Take IT este partenerul oficial de service al Datalogic în Moldova. Tehnicienii noștri înalt calificați oferă servicii de garanție și post-garanție pentru echipamente noi și existente. Specializați în gestionarea documentației și altor aspecte esențiale, contribuim la funcționarea optimă a companiei dvs., asigurându-ne că toate necesitățile sunt îndeplinite în mod profesional. O echipă de tehnicieni este întotdeauna la dispoziția dvs., acoperind fiecare colț al țării.</div>
                <div class="service-one-slide-content" v-if="!language">Take ITОн является официальным партнером по обслуживанию DataLogic в Молдове.Наши высококвалифицированные специалисты предлагают гарантию и услуги постгаранты для нового и существующего оборудования.Специализируясь на управлении документацией и другими основными аспектами, мы способствуем оптимальному функционированию вашей компании, следя за тем, чтобы все потребности удовлетворялись профессионально.Команда техников всегда в вашем распоряжении, охватывающей каждый угол страны.</div>
    </div>
  </div>
